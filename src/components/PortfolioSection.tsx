...
export const PortfolioSection = () => {
  ...
  const handleViewReadme = () => setShowReadme(true);
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Explore our collection of websites, and innovative solutions
          </p>
        </div>
        ...
        <Swiper
          ...
          pagination={{
            clickable: true,
            bulletClass: "swiper-pagination-bullet glass-card bg-accent/50 hover:bg-accent",
        ...
        >
          {portfolioProjects.map((project) => (
            <SwiperSlide key={project.id}>
              <Card
                className="glass-card hover-lift cursor-pointer group transition-all duration-300 hover:neon-glow flex flex-col justify-between h-[28rem]"
                onClick={() => handleProjectClick(project)}
              >
                {/* Top Image / Badges */}
                <div className="aspect-video bg-gradient-to-br from-primary/20 to-accent/20 relative overflow-hidden flex-shrink-0">
                  ...
                  <Badge className="absolute top-4 left-4 bg-primary/80">{project.type}</Badge>
                  <Badge className="absolute top-4 right-4 bg-accent/80">{project.category}</Badge>
                </div>
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Badge className="bg-primary/20 text-primary">{selectedProject.type}</Badge>
                        <Badge className="bg-accent/20 text-accent">{selectedProject.category}</Badge>
                      </div>
                    </div>
                  </div>
                </DialogHeader>
                ...
                {!showReadme ? (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedProject.technologies.map((tech) => (
                          <Badge key={tech} variant="outline" className="bg-primary/10">{tech}</Badge>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                      <Button onClick={handleViewReadme} className="neon-glow hover-lift">
                        <FileText className="mr-2 h-4 w-4" />
                        View README
                      </Button>
                      <Button variant="outline" className="glass-card border-primary hover:neon-glow" onClick={() => window.open(selectedProject.liveDemo, "_blank")}>
                        <ExternalLink className="mr-2 h-4 w-4" />
                        Live Demo
                      </Button>
                      <Button variant="outline" className="glass-card border-accent hover:neon-glow-green" onClick={() => window.open(selectedProject.github, "_blank")}>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="outline" size="sm" onClick={() => setShowReadme(false)}>
                        Back to Project
                      </Button>
                    </div>
